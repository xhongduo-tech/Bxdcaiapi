        ...
        <div className="flex items-start justify-between">
          ...
          {newCount > 0 && (
            <motion.div
              ...
              className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/8 text-primary text-[12px]"
      ...
      <div className="space-y-8">
        {monthGroups.map((group, gi) => (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.05 + gi * 0.06, duration: 0.35 }}
          >
            {/* Month label */}
                ...
                {group.items.map((n, i) => {
                  ...
                  return (
                    <motion.div
                      ...
                      transition={{ delay: gi * 0.05 + i * 0.05 + 0.1, duration: 0.3, ease: [0.25, 0.1, 0.25, 1] }}
                    ...
                    >
                      ...
                      <div className="relative z-10 shrink-0 mt-4">
                        <motion.div
                          initial={{ scale: 0 }}
                          animate={{ scale: 1 }}
                          transition={{ delay: gi * 0.05 + i * 0.05 + 0.15, type: "spring", stiffness: 350 }}
